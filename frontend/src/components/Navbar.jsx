...
function Navbar() {
  ...
  return (
    <>
    <div className={`w-full  mx-auto  md:px-20 px-4  dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 z-50 ${
        sticky?"sticky-navbar shadow-md bg-base-200  dark:bg-slate-600 dark:text-white duration-200 transition-all ease-in-out ":""
    }`}>
  ...
  <input type="text" className={`grow outline-none dark:bg-slate-${sticky?600:900} dark:text-white`} placeholder="Search" />
